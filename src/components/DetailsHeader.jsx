...
const DetailsHeader = ({ artistId, artistData, songData }) => {
  ...
  return (
    <div className="relative w-full flex flex-col">
      <div className="w-full bg-gradient-to-l from-transparent to-neutral-900 rounded-lg sm:h-48 h-28">
        <div className="absolute inset-0 flex items-center">
          <img
            ...
            alt="art"
            className="sm:w-48 w-28 sm:h-48 h-28 rounded-full object-cover shadow-xl shadow-neutral-800"
          />
